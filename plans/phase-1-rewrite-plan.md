...
/games/:gameId     → GamePage (внутри игры - меню разделов)
  ├── players      → Список игроков (только GM)
  ├── knowledge    → База знаний
  ├── characters   → Список персонажей
  ├── character/:charId → Лист персонажа
  └── items        → Общие айтемы (карты, записки)
```
...
### Phase 7: Управление игрой (1-2 часа)
1. ✅ Список игроков (PlayersList)
2. ✅ Приглашение игроков (по email)
3. ✅ Передача прав GM
4. ✅ Общие айтемы игры (карты, записки)
